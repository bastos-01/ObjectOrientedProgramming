...
public class Ex5_2 {
	...
	public static void main(String[] args) {
		...
		// Este vetor tem uma dimensão fixa pelo que se for necessário guardar 
		// mais livros, teremos de criar um vetor de maior dimensão.
		...
		// Para o conjunto de utilizadores usamos a classe java.util.ArrayList // É uma implementação de um vetor com tamanho variável 
